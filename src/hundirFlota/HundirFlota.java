...
public class HundirFlota {
	...
	public static void main(String[] args) {
		...
		// Inicializamos le mapa de registro a AGUA_NO_TOCADO
	 ...
	 */
	private static int[] generarDisparoAleatorio() {
	...
	private static void inicializaMapa(char[][] mapa) {
		...
		for (int b : barcos) {
			...
			// Vamos de mayor a menor, para que sea menos
	...
	public static void imprimirMapa(char[][] mapa) {
		...
		// Imprimimos la fila del encabezado
		System.out.print("    ");
	...
	private static int[] pedirCasilla() {
		...
		// Comprobamos que lo introducido por el usuario es correcto mediante una expresión regular
	 ...
	 * o se trata de na casilla por la que ya hemos pasado antes.
	 */
